...
public class Client {
    ...
    public Client(){
        ...
        //ObjectOutputStream objectOut = new ObjectOutputStream(socket.getOutputStream());
            ...
            while(g.userInput != null){ //Loop om den inte är null
                ...
                System.out.println("Sent to OLD.Server: "+userListener); //Skriver ut de användaren skrev
    ...
    public static void main(String[] args) {Client c = new Client();} //Anropar OLD.Client med hjälp av c
}
